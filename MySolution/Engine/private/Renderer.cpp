...
HRESULT CRenderer::NativeConstruct_Prototype()
{
	...
	//m_pVIBuffer = CVIBuffer_RectViewPort::Create(m_pDevice, m_pDeviceContext, 0.f, 0.f, ViewportDesc.Width, ViewportDesc.Height, TEXT(".../Client/Bin/ShaderFiles/Shader_RectViewPort.hlsl"));
